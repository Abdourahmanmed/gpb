...
export const FetchNombreabonneNonAjour = async () => {
    const api = `http://192.168.0.15/gbp_backend/api.php?method=countClientsWithoutPaymentsOrWithNonUpdatedPayments`;
