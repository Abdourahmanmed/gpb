...
export const FetchAllChangeName = async () => {
  const api = `http://192.168.0.15/gbp_backend/api.php?method=getClientsWithPayments`;
  ...
  try {
    ...
    return responseData.clients; // Retourne les données si tout va bien
  } catch (error) {
