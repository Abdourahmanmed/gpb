...
export const ChangementClePaiement = async (userid: string, data: dataType) => {
    const api = `http://192.168.0.15/gbp_backend/api.php?method=addMontantAchatsCle&id=${userid}`;
    try {
