...
const StepFourForme = () => {
  ...
  const handlePayer = async (value: MontantSaisi) => {
    ...
    if (files[0]?.Abonnement)
      formData.append("Abonnement", files[0].Abonnement);
    if (files[0]?.patent_quitance)
      formData.append("patent_quitance", files[0].patent_quitance);
                  ...
                  <table className="w-full border border-gray-200 text-sm">
                    ...
                    <tbody>
                      <tr>
                        ...
                        {/* Service additionnel */}
                        <td className="p-2 border text-center">
                          {Array.isArray(donnees?.sousCouvertures) &&
                          donnees.sousCouvertures.filter(
                            (sc) => sc && sc.societe?.trim() !== ""
                          ).length > 0 ? (
                            <Check />
                          ) : (
                            <X />
                        ...
                        <td className="p-2 border text-center">
                          {donnees?.Adresse_Livraison_Domicile ? (
                            <Check />
                          ) : (
                            <X />
                          )}
                      ...
                      <tr>
                        <td
                          colSpan={9}
                          className="text-right pr-3 font-semibold"
                        >
                          Montant Total :
                        </td>
