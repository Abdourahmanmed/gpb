...
export const ChangeCleForm: React.FC<PaymentFormProps> = ({ isOpen, setIsOpen }) => {
    ...
    useEffect(() => {
        ...
        const newRecueNumber = `ACLE/${paddedNumber}/${formattedDate}`;
    ...
    const onSubmit = (values: PaiementFormValues) => {
        console.log(values); // Logique d'enregistrement
        setDonnees(values)
        ...
        <>
            ...
            <Dialog open={isOpen} onOpenChange={(open) => setIsOpen(open)}>
                <DialogContent>
                    <div>
                        <DialogHeader>
                            <DialogTitle className="text-primary text-xl">Changemnt cle</DialogTitle>
                        </DialogHeader>
                ...
                <DialogContent className="p-8 bg-white rounded-xl shadow-lg max-w-2xl mx-auto">
                    <ScrollArea className="max-h-[70vh] w-full">
                        <DialogHeader className="border-b-2 pb-4 mb-6">
                            <DialogTitle className="text-2xl font-bold text-gray-800">Résumé des informations achat cle</DialogTitle>
                        </DialogHeader>
