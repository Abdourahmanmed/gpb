...
import { AcceptationColumns } from "./columns/AcceptePaiementyearCol";


const AcceptationPaiement = () => {
    ...
    return (
        <div>
            {loading ? (
                ...
                <NoFilterDataTable data={clients} columns={AcceptationColumns} typeName="Nom" />
            )}
        </div>
...
export default AcceptationPaiement;
